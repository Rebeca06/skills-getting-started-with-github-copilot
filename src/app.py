...
activities = {
    ...
    "Swimming Club": {
        "description": "Learn swim techniques and train for swimming competitions",
    ...
    "Drama Club": {
        "description": "Practice acting, stagecraft, and put on student performances",
        "schedule": "Fridays, 3:30 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["mia@mergington.edu", "ethan@mergington.edu"]
    },
    "Science Explorers": {
        "description": "Investigate science experiments and STEM challenges",
